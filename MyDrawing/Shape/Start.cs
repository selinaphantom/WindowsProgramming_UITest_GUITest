...
namespace MyDrawing
{
    public class Start : IShape //使用IShape介面實作功能，詳細內容在IShape。
    {
        ...
        public Start(string InputText, int InputX, int InputY, int InputHeight, int InputWidth) //解建構子。
        {
            _ShapeName = "Start";
        ...
        {
            graphics.DrawEllipse(_ShapeX, _ShapeY, _ShapeWidth, _ShapeHeight);
        ...
        public bool CheckInPoint(double x, double y)
        {
            ...
            graphicsPath.AddEllipse(_ShapeX, _ShapeY, _ShapeWidth, _ShapeHeight);
