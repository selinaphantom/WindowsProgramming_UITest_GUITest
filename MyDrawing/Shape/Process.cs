...
namespace MyDrawing
{
    public class Process : IShape //使用IShape介面實作功能，詳細內容在IShape。
    {
        ...
        public Process(string InputText, int InputX, int InputY, int InputHeight, int InputWidth) //解建構子。
        {
            _ShapeName = "Process";
        ...
        {
            graphics.DrawRectangle(_ShapeX, _ShapeY, _ShapeWidth, _ShapeHeight);
        ...
        {
            GraphicsPath graphicsPath = new GraphicsPath();
            graphicsPath.AddLine(_ShapeX, _ShapeY, _ShapeX + _ShapeWidth, _ShapeY);
            graphicsPath.AddLine(_ShapeX + _ShapeWidth, _ShapeY, _ShapeX + _ShapeWidth, _ShapeY + _ShapeHeight);
            graphicsPath.AddLine(_ShapeX + _ShapeWidth, _ShapeY + _ShapeHeight, _ShapeX, _ShapeY + _ShapeHeight);
            graphicsPath.AddLine(_ShapeX, _ShapeY + _ShapeHeight, _ShapeX, _ShapeY);
